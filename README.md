...
Pushing a tag by hand still works and takes the same path — `git tag v0.147.0
&& git push origin v0.147.0`. Nothing is ever published from a commit whose CI
did not pass.
