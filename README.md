...
Pushing a tag by hand still works and takes the same path — `git tag v0.141.1
&& git push origin v0.141.1`. Nothing is ever published from a commit whose CI
did not pass.
