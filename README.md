...
## The language (v0.64.0)

Versioning is **MAJOR.MINOR.PATCH**. PyRs stays on **0.y.z** (next
milestone after this one is **0.65.0**, not 1.0) until it is ready for
...
Known limits (v0.64.0): `int` is arbitrary precision (tagged small ±2⁶² /
...
Release tags: `git tag v0.64.0 && git push origin v0.64.0`.
