...
**v0.130** / `0.130.0`. Optional release tags: `vX.Y.Z`.
...
| Product version  | `0.130.0` (and later `0.131.0`, …)                      | Do not ship **1.0.0** until memory + readiness bar are met                |
