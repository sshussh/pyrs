...
**v0.103** / `0.103.0`. Optional release tags: `vX.Y.Z`.
...
| Product version  | `0.103.0` (and later `0.104.0`, …)                      | Do not ship **1.0.0** until memory + readiness bar are met                |
