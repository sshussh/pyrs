...
**v0.127** / `0.127.0`. Optional release tags: `vX.Y.Z`.
...
| Product version  | `0.127.0` (and later `0.128.0`, …)                      | Do not ship **1.0.0** until memory + readiness bar are met                |
