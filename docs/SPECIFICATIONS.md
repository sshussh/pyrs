...
**v0.111** / `0.111.0`. Optional release tags: `vX.Y.Z`.
...
| Product version  | `0.111.0` (and later `0.112.0`, …)                      | Do not ship **1.0.0** until memory + readiness bar are met                |
