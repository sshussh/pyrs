...
**v0.138** / `0.138.1`. Optional release tags: `vX.Y.Z`.
...
| Product version  | `0.138.1` (and later `0.139.0`, …)                      | Do not ship **1.0.0** until memory + readiness bar are met                |
