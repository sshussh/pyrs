...
**v0.92** / `0.92.0`. Optional release tags: `vX.Y.Z`.
...
| Product version  | `0.92.0` (and later `0.93.0`, …)                      | Do not ship **1.0.0** until memory + readiness bar are met                |
