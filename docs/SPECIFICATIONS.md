...
**v0.76** / `0.76.0`. Optional release tags: `vX.Y.Z`.
...
| Product version  | `0.76.0` (and later `0.77.0`, …)                      | Do not ship **1.0.0** until memory + readiness bar are met                |
