...
**v0.97** / `0.97.0`. Optional release tags: `vX.Y.Z`.
...
| Product version  | `0.97.0` (and later `0.98.0`, …)                      | Do not ship **1.0.0** until memory + readiness bar are met                |
