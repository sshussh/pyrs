...
**v0.73** / `0.73.0`. Optional release tags: `vX.Y.Z`.
...
| Product version  | `0.73.0` (and later `0.74.0`, …)                      | Do not ship **1.0.0** until memory + readiness bar are met                |
