...
**v0.84** / `0.84.0`. Optional release tags: `vX.Y.Z`.
...
| Product version  | `0.84.0` (and later `0.85.0`, …)                      | Do not ship **1.0.0** until memory + readiness bar are met                |
