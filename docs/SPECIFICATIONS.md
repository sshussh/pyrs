...
**v0.137** / `0.137.0`. Optional release tags: `vX.Y.Z`.
...
| Product version  | `0.137.0` (and later `0.138.0`, …)                      | Do not ship **1.0.0** until memory + readiness bar are met                |
