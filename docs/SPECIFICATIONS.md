...
**v0.135** / `0.135.0`. Optional release tags: `vX.Y.Z`.
...
| Product version  | `0.135.0` (and later `0.136.0`, …)                      | Do not ship **1.0.0** until memory + readiness bar are met                |
