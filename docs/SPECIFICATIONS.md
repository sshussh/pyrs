...
**v0.119** / `0.119.0`. Optional release tags: `vX.Y.Z`.
...
| Product version  | `0.119.0` (and later `0.120.0`, …)                      | Do not ship **1.0.0** until memory + readiness bar are met                |
