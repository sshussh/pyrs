...
`Upper`, `Lower`, `CaseFold`, `MakeTrans`, `MakeTransDelete`, `Translate`, `Capitalize`, `Title`, `SwapCase`, `ZFill`, `Center`, `LJust`, `RJust`, `Strip`, `Lstrip`, `Rstrip`, `StripChars`, `LstripChars`, `RstripChars`, `StartsWith`, `EndsWith`,
